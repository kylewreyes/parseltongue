...
public class JaccardishTest {
  Jaccardish cs = new Jaccardish();
  @Test
  public void JaccardTest() {
    ...
    assertEquals(cs.calculateRelevance(v1,v1),1,0.00001);
    assertEquals(cs.calculateRelevance(v1,v4),0.5,0.00001);
